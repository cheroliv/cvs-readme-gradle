...
group = "com.cheroliv"
version = libs.plugins.asciidoc.plantuml.readme.get().version
...
gradlePlugin {
    // Define the plugin
    val readme by plugins.creating {
        id = "com.cheroliv.cvs.readme"
        implementationClass = "com.cheroliv.cvs.readme.CvsReadmeGradlePlugin"
    }
}
...
//            implementationClass = "${libs.plugins.slider.get().pluginId}.ReadMePlugin"
//            displayName = "Readme Plugin"
//            description = "Gradle plugin for README.adoc generation."
//            listOf(
//                "revealjs",
//                "slide-generator",
//                "slide",
...
//    vcsUrl = "https://github.com/cheroliv/asciidoc-plantuml-gradle.git"
...
//            if (name == "pluginMaven") {
//                pom {
//                    name.set(gradlePlugin.plugins.getByName("asciidoc-plantuml-readme").displayName)
//                    description.set(gradlePlugin.plugins.getByName("asciidoc-plantuml-readme").description)
